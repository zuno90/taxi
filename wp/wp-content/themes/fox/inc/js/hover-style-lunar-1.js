var phaohoa = document.getElementById("phaohoa");
var ctx = phaohoa.getContext("2d");
var cwidth, cheight;
var shells = [];
var pass= [];
...
function reset() {
  ...
  cwidth = window.innerWidth;
	...
	phaohoa.width = cwidth;
	phaohoa.height = cheight;
}
...
function Run() {
  ...
  if (lastRun != 0) { dt = Math.min(50, (performance.now() - lastRun)); }
	...
	ctx.fillStyle = getComputedStyle(phaohoa).getPropertyValue("--body");
